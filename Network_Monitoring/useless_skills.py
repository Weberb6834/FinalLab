...
teams_token = 'MDBmNDY3MDYtNjcxZi00YTI5LTk5Y2YtOTQxYjRkNWU0ZjI4NmRmYWExZTktMDAx_P0A1_529b5ae9-ae34-46f8-9993-5c34c3d90856'#
...
def do_something(incoming_msg):
    ...
    """
    return "Flash banging Nam, there I {}".format(incoming_msg.text)

def Reply_something(incoming_msg):
    """
    Function to do some action.
    :param incoming_msg: The incoming message object from Teams
    :return: A text or markdown based reply
    """
    return "What are you going to do about it".format(incoming_msg.text)
